...
std::shared_ptr<const AsmIndex> AsmRedirectRegister::GetEntry(const ILInstruction& instruction) const
{
	...
	return m_Entries[static_cast<uint8_t>(operand.m_Register.m_Type)]->GetEntry(instruction);
}